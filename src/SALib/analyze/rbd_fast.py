...
from python_inferno.cache import mark_dependency, cache
...
@cache(
    dependencies=[permute_outputs, compute_first_order, unskew_S1, bootstrap],
    ignore=["print_to_console"],
)
def rbd_fast_analyze(
    problem,
    X,
    Y,
    M=10,
